 ...
 * @method string|null     getBody()             This method returns the body of the response.
 ...
 *
 * @method $this setBody(string|null $body)         This method sets the body of the response.
 * @method $this setHeaderSize(int $size)           This method sets the header size of the response.
 * @method $this setStatusCode(int $code)           This method sets the status code of the response.
 */
class HttpResponse
{
     ...
     */
    public function getInfo(): CurlInfo|false
    {
